...
#define __KERNEL_HEADERS__ "/usr/src/output/build/linux-headers-4.14.33/usr/include"
...
#define __CROSS_COMPILER_PREFIX__ "/usr/src/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-"
