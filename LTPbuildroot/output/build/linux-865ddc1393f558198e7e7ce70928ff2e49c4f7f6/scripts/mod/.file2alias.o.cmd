cmd_scripts/mod/file2alias.o := /usr/bin/gcc -O2 -I/usr/src/output/host/include -L/usr/src/output/host/lib -Wl,-rpath,/usr/src/output/host/lib -Wp,-MD,scripts/mod/.file2alias.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89      -c -o scripts/mod/file2alias.o scripts/mod/file2alias.c
