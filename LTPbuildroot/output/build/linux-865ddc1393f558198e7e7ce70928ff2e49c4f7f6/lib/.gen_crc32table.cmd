cmd_lib/gen_crc32table := /usr/bin/gcc -O2 -I/usr/src/output/host/include -L/usr/src/output/host/lib -Wl,-rpath,/usr/src/output/host/lib -Wp,-MD,lib/.gen_crc32table.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89      -o lib/gen_crc32table lib/gen_crc32table.c  
