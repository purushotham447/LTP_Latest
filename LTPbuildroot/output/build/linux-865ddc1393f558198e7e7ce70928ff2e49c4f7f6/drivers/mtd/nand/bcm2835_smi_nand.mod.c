...
__attribute__((section("__versions"))) = {
	...
	{ 0xb0068d54, __VMLINUX_SYMBOL_STR(nand_scan_tail) },
	{ 0xd458e3aa, __VMLINUX_SYMBOL_STR(nand_scan_ident) },
	...
	{ 0xfb526ed8, __VMLINUX_SYMBOL_STR(nand_release) },
...
MODULE_INFO(srcversion, "46501C8E15FB83AAE1D086B");
