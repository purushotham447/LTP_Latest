...
am_rel_srcdir='.'
am_top_srcdir='/usr/src/output/build/host-automake-1.15.1'
am_top_builddir='/usr/src/output/build/host-automake-1.15.1'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/usr/src/output/host/share/automake-1.15/am'
    am_automake_acdir='/usr/src/output/host/share/aclocal-1.15'
    am_bindir='/usr/src/output/host/bin'
    am_datadir='/usr/src/output/host/share'
    am_docdir='/usr/src/output/host/share/doc/automake'
    am_pkgvdatadir='/usr/src/output/host/share/automake-1.15'
    am_scriptdir='/usr/src/output/host/share/automake-1.15'
    am_system_acdir='/usr/src/output/host/share/aclocal'
    ;;
  no)
...
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/usr/src/output/host/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/usr/src/output/host/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/usr/src/output/host/include'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/usr/src/output/host/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/usr/src/output/host/include'}}
