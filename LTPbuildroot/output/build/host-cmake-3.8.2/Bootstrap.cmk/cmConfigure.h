/*
 * Generated by /usr/src/output/build/host-cmake-3.8.2/bootstrap
 * Version:     $Revision$
 *
 * Source directory: /usr/src/output/build/host-cmake-3.8.2
 * Binary directory: /usr/src/output/build/host-cmake-3.8.2/Bootstrap.cmk
 *
 * C compiler:   /usr/bin/gcc
 * C flags:      -O2 
 *
 * C++ compiler: /usr/bin/g++
 * C++ flags:    -O2 -I/usr/src/output/host/include
 *
 * Make:         make
 *
 * Sources:
...
#define CMAKE_BOOTSTRAP_SOURCE_DIR "/usr/src/output/build/host-cmake-3.8.2"
#define CMAKE_BOOTSTRAP_BINARY_DIR "/usr/src/output/build/host-cmake-3.8.2"
