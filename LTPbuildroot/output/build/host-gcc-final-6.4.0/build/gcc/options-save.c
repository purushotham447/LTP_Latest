...
{
  inchash::hash hstate;
  hstate.add_wide_int (ptr->x_inline_asm_unified);
  hstate.add_wide_int (ptr->x_arm_fpu_index);
  hstate.add_wide_int (ptr->x_arm_restrict_it);
  hstate.add_wide_int (ptr->x_target_flags);
  hstate.add_wide_int (ptr->x_unaligned_access);
  return hstate.end ();
}
                            ...
                            struct cl_target_option *ptr ATTRIBUTE_UNUSED)
{
  ...
  ptr->x_arm_fpu_index = (int ) bp_unpack_value (bp, 64);
