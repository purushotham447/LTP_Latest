...
#line 36 "../../gcc/config/arm/predicates.md"
{
  return (TARGET_NEON
...
#line 59 "../../gcc/config/arm/predicates.md"
{
...
#line 118 "../../gcc/config/arm/predicates.md"
(subreg_lowpart_p (op)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 127 "../../gcc/config/arm/predicates.md"
...
arm_immediate_di_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 133 "../../gcc/config/arm/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 137 "../../gcc/config/arm/predicates.md"
(const_ok_for_arm (-INTVAL (op))));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 145 "../../gcc/config/arm/predicates.md"
(INTVAL (op) == 0));
}
...
#line 158 "../../gcc/config/arm/predicates.md"
...
{
  return (const_int_operand (op, mode)) && (
#line 162 "../../gcc/config/arm/predicates.md"
...
{
  return ((
#line 167 "../../gcc/config/arm/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 173 "../../gcc/config/arm/predicates.md"
...
{
  return (const_int_operand (op, mode)) && (
#line 178 "../../gcc/config/arm/predicates.md"
...
#line 187 "../../gcc/config/arm/predicates.md"
...
{
  return (s_register_operand (op, mode)) || ((((GET_CODE (op) == CONST_INT) && (
#line 193 "../../gcc/config/arm/predicates.md"
...
{
  return (s_register_operand (op, mode)) || (((GET_CODE (op) == CONST_INT) && (
#line 199 "../../gcc/config/arm/predicates.md"
...
{
  return (s_register_operand (op, mode)) || (((GET_CODE (op) == CONST_INT) && (
#line 204 "../../gcc/config/arm/predicates.md"
...
#line 223 "../../gcc/config/arm/predicates.md"
...
{
  return (GET_CODE (op) == MEM) && ((
#line 230 "../../gcc/config/arm/predicates.md"
...
#line 244 "../../gcc/config/arm/predicates.md"
...
{
  return (
#line 247 "../../gcc/config/arm/predicates.md"
...
#line 255 "../../gcc/config/arm/predicates.md"
((!CONST_INT_P (op)
...
shiftable_operator (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 261 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op));
}
...
shiftable_operator_strict_it (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 265 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op));
}
...
commutative_binary_operator (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 275 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op));
}
...
#line 287 "../../gcc/config/arm/predicates.md"
...
#line 292 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op)));
}
...
#line 296 "../../gcc/config/arm/predicates.md"
(CONST_INT_P (XEXP (op, 1))
			      && ((unsigned HOST_WIDE_INT) INTVAL (XEXP (op, 1))) < 32))) || ((GET_CODE (op) == ASHIFT || GET_CODE (op) == ASHIFTRT || GET_CODE (op) == LSHIFTRT || GET_CODE (op) == ROTATERT) && (
#line 299 "../../gcc/config/arm/predicates.md"
(!CONST_INT_P (XEXP (op, 1))
			      || ((unsigned HOST_WIDE_INT) INTVAL (XEXP (op, 1))) < 32)))) && (
#line 301 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op)));
}
...
{
  return (((GET_CODE (op) == MULT) && (
#line 306 "../../gcc/config/arm/predicates.md"
(power_of_two_operand (XEXP (op, 1), mode)))) || ((GET_CODE (op) == ASHIFT || GET_CODE (op) == ASHIFTRT) && (
#line 308 "../../gcc/config/arm/predicates.md"
(CONST_INT_P (XEXP (op, 1))
		              && ((unsigned HOST_WIDE_INT) INTVAL (XEXP (op, 1)) < 32))))) && (
#line 310 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op)));
}
...
#line 334 "../../gcc/config/arm/predicates.md"
...
{
  return (
#line 359 "../../gcc/config/arm/predicates.md"
(arm_restrict_it)) ? ((
#line 360 "../../gcc/config/arm/predicates.md"
...
minmax_operator (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 369 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op));
}
...
(REGNO (op) == CC_REGNUM)) && ((
#line 374 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op))) || (
#line 375 "../../gcc/config/arm/predicates.md"
...
#line 440 "../../gcc/config/arm/predicates.md"
{
  if (s_register_operand (op, mode))
    return true;
...
#line 473 "../../gcc/config/arm/predicates.md"
{
 return ldm_stm_operation_p (op, /*load=*/true, SImode,
                                 /*consecutive=*/false,
                                 /*return_pc=*/true);
...
#line 489 "../../gcc/config/arm/predicates.md"
{
...
#line 500 "../../gcc/config/arm/predicates.md"
{
...
#line 535 "../../gcc/config/arm/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 539 "../../gcc/config/arm/predicates.md"
...
#line 553 "../../gcc/config/arm/predicates.md"
...
#line 569 "../../gcc/config/arm/predicates.md"
{
...
#line 582 "../../gcc/config/arm/predicates.md"
{
...
#line 588 "../../gcc/config/arm/predicates.md"
{
...
{
  return (
#line 603 "../../gcc/config/arm/predicates.md"
...
#line 614 "../../gcc/config/arm/predicates.md"
{
...
#line 643 "../../gcc/config/arm/predicates.md"
{
  HOST_WIDE_INT count = XVECLEN (op, 0);
  int i;
  int base = GET_MODE_NUNITS (mode);
...
{
  return ((GET_CODE (op) == CONST_DOUBLE) && (
#line 672 "../../gcc/config/arm/predicates.md"
...
#line 701 "../../gcc/config/arm/predicates.md"
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_Pj:
      return (
#line 78 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2)) && (
#line 79 "../../gcc/config/arm/constraints.md"
((ival & 0xfffff000) == 0));

    case CONSTRAINT_PJ:
      return (
#line 84 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2)) && (
#line 85 "../../gcc/config/arm/constraints.md"
(((-ival) & 0xfffff000) == 0));
...
(TARGET_THUMB2 && ival >= -255 && ival <= 255);
    ...
    case CONSTRAINT_Pt:
      return 
#line 191 "../../gcc/config/arm/constraints.md"
